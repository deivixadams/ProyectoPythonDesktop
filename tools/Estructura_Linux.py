...
# 🚀 Función para crear la estructura en Linux
def create_structure():
    for root_folder, items in project_structure.items():
        root_folder = os.path.abspath(root_folder)  # Convierte la ruta en absoluta
    ...
    print("✅ Estructura del proyecto creada correctamente en Linux.")
